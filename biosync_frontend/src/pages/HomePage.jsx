    ...
    <div style={{
      ...
      <style>
        {`
          ...
          .grid-auto-fit { display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2rem; }
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth'})}>
          ...
          <span style={{ fontSize: '1.25rem', fontWeight: '800', letterSpacing: '0.25em', textTransform: 'uppercase' }}>
            BIOSYNC
          </span>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '3rem' }}>
          ...
          <button 
            ...
            style={{
              backgroundColor: '#fff', color: '#000', border: 'none', padding: '0.65rem 1.5rem', borderRadius: '4px',
          ...
          >
            Terminal Login <ArrowRight size={14} />
          </button>
        </div>
      </nav>
      ...
      {/* 2. HERO SECTION */}
      <section style={{
        padding: '10rem 2rem 8rem', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center',
        ...
        <div style={{
          ...
          border: '1px solid rgba(255,255,255,0.1)', borderRadius: '50px', marginBottom: '2.5rem',
          fontSize: '0.75rem', fontWeight: '700', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#ccc'
        }}>
          <Activity size={12} color="#4ade80" /> Institution-Grade Attendance Intelligence
        </div>
        
        <h1 style={{
          fontSize: 'clamp(2.5rem, 6vw, 5rem)', fontWeight: '800', letterSpacing: '-0.03em', lineHeight: '1.1',
          maxWidth: '1000px', margin: '0 0 1.5rem 0', color: '#fff', position: 'relative'
        }}>
          Centralized Attendance Operations &amp; Intelligence Layer.
        </h1>
        
        <p style={{
          fontSize: '1.2rem', color: '#888', maxWidth: '800px', lineHeight: '1.7', margin: '0 0 3.5rem 0', fontWeight: '400'
        }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
          <button 
            ...
            style={{
              ...
              padding: '1.1rem 2.5rem', borderRadius: '4px', fontSize: '0.85rem', fontWeight: '700',
              textTransform: 'uppercase', letterSpacing: '0.1em', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.75rem', transition: 'all 0.2s'
            }}
          ...
          <button 
            onClick={() => navigate('/login')}
            style={{
              backgroundColor: '#fff', color: '#000', border: '1px solid #fff', padding: '1.1rem 2.5rem', borderRadius: '4px',
      ...
      <section id="oversight" style={{ padding: '8rem 2rem', background: '#080808', borderTop: '1px solid #1a1a1a', borderBottom: '1px solid #1a1a1a' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(500px, 1fr))', gap: '4rem', alignItems: 'center' }}>
            <div style={{ paddingRight: '2rem' }}>
              <div style={{ color: '#60a5fa', fontSize: '0.85rem', fontWeight: '700', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: '1rem' }}>Executive-Level Visibility</div>
              <h2 style={{ fontSize: '3rem', fontWeight: '800', lineHeight: '1.1', marginBottom: '2rem', letterSpacing: '-0.02em', color: '#fff' }}>
                Engineered for Complete Institutional Oversight.
              </h2>
              <p style={{ fontSize: '1.2rem', color: '#999', lineHeight: '1.7', marginBottom: '2rem' }}>
              ...
              <p style={{ fontSize: '1.1rem', color: '#777', lineHeight: '1.7' }}>
      ...
      <section id="bot" style={{ padding: '8rem 2rem', background: '#030303', borderBottom: '1px solid #1a1a1a', overflow: 'hidden' }}>
         <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
               <h2 style={{ fontSize: '3rem', fontWeight: '800', margin: '0 0 1rem 0' }}>Conversational Attendance Access.</h2>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(500px, 1fr))', gap: '4rem', alignItems: 'stretch' }}>
               
               {/* Left: Allowed Query Formats */}
               <div style={{ background: '#0a0a0a', border: '1px solid #222', borderRadius: '4px', padding: '3rem', display: 'flex', flexDirection: 'column' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
                     <MessageSquare size={28} color="#25D366" />
                     <h3 style={{ fontSize: '1.5rem', fontWeight: '800', margin: 0 }}>Authorized Query Formats</h3>
                  </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    {[
                      ...
                      <div key={i} style={{ borderLeft: '2px solid #333', paddingLeft: '1rem' }}>
                        <div style={{ fontSize: '0.8rem', color: '#999', marginBottom: '0.5rem', fontWeight: '600', textTransform: 'uppercase' }}>{q.type}</div>
                        <div style={{ fontFamily: 'monospace', fontSize: '0.9rem', color: '#60a5fa', background: '#112', padding: '0.5rem 1rem', borderRadius: '4px', border: '1px solid #1a2333', display: 'inline-block' }}>
                          {q.cmd}
                        </div>
                      </div>
                    ))}
               ...
               <div style={{ background: '#0a0b0d', border: '1px solid #222', borderRadius: '12px', overflow: 'hidden', display: 'flex', flexDirection: 'column', boxShadow: '0 20px 40px rgba(0,0,0,0.5)' }}>
                 {/* WA Header */}
                 ...
                 <div className="custom-scrollbar" style={{ padding: '1.5rem', background: '#0b141a', flex: 1, display: 'flex', flexDirection: 'column', gap: '1.5rem', overflowY: 'auto' }}>
                    ...
                    {/* User Msg */}
                    <div style={{ alignSelf: 'flex-end', background: '#005c4b', color: '#e9edef', padding: '0.5rem 1rem', borderRadius: '8px 8px 0 8px', maxWidth: '80%', fontSize: '0.9rem', position: 'relative' }}>
                    ...
                    {/* Bot Msg */}
                    <div style={{ alignSelf: 'flex-start', background: '#202c33', color: '#e9edef', padding: '1rem', borderRadius: '0 8px 8px 8px', maxWidth: '90%', fontSize: '0.85rem', fontFamily: 'monospace', whiteSpace: 'pre-wrap', lineHeight: '1.5' }}>
                    ...
                    {/* Bot Msg 2 */}
                    <div style={{ alignSelf: 'flex-start', background: '#202c33', color: '#e9edef', padding: '1rem', borderRadius: '0 8px 8px 8px', maxWidth: '90%', fontSize: '0.85rem', lineHeight: '1.5' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', background: '#111b21', padding: '1rem', borderRadius: '4px', border: '1px solid #333' }}>
      ...
      <section id="modules" style={{ padding: '8rem 2rem', backgroundColor: '#0a0a0a', borderBottom: '1px solid #1a1a1a' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ marginBottom: '5rem', textAlign: 'center' }}>
            <div style={{ color: '#60a5fa', fontSize: '0.85rem', fontWeight: '700', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: '1rem' }}>Architectural Segments</div>
            <h2 style={{ fontSize: '3rem', fontWeight: '800', margin: '0 0 1rem 0' }}>Core Platform Modules.</h2>
            <p style={{ color: '#888', fontSize: '1.1rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <section style={{ padding: '8rem 2rem', background: '#030303', borderBottom: '1px solid #1a1a1a' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ marginBottom: '5rem', textAlign: 'center' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: '800', margin: '0 0 1rem 0' }}>Internal Environment Mocks.</h2>
            <p style={{ color: '#888', fontSize: '1.1rem', maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(500px, 1fr))', gap: '3rem' }}>
              ...
              <div style={{ background: '#0a0a0a', border: '1px solid #222', borderRadius: '8px', overflow: 'hidden' }}>
                <div style={{ padding: '1rem 1.5rem', background: '#111', borderBottom: '1px solid #222', fontSize: '0.65rem', fontWeight: '800', letterSpacing: '0.15em', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <PieChart size={14} color="#60a5fa" /> DEPARTMENT DASHBOARD (MOCK)
                </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                      {['Computer Science', 'Electrical', 'Mechanical'].map((d, i) => (
                        <div key={i} style={{ display: 'flex', alignItems: 'center' }}>
                          <div style={{ width: '150px', fontSize: '0.75rem', color: '#999', textTransform: 'uppercase' }}>{d}</div>
                          <div style={{ flex: 1, background: '#222', height: '10px', borderRadius: '5px', overflow: 'hidden' }}>
                            <div style={{ width: `${88 - i*6}%`, height: '100%', background: '#60a5fa' }}></div>
                          </div>
                          <div style={{ width: '40px', textAlign: 'right', fontSize: '0.75rem', fontWeight: '800' }}>{88 - i*6}%</div>
                        </div>
                      ))}
                    </div>
                  </div>
               ...
               <div style={{ background: '#0a0a0a', border: '1px solid #222', borderRadius: '8px', overflow: 'hidden' }}>
                <div style={{ padding: '1rem 1.5rem', background: '#111', borderBottom: '1px solid #222', fontSize: '0.65rem', fontWeight: '800', letterSpacing: '0.15em', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Server size={14} color="#60a5fa" /> ADMIN SDK PULL CONTROL (MOCK)
                </div>
                <div style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                   <div style={{ background: '#141414', border: '1px solid #333', padding: '1.5rem', borderRadius: '4px' }}>
                     ...
                     <div style={{ marginBottom: '1rem' }}>
                       ...
                       <div style={{ padding: '0.5rem 1rem', background: '#000', border: '1px solid #222', fontSize: '0.8rem', color: '#888' }}>ALL REGISTERED CAMPUS NODES</div>
                     </div>
                     <button style={{ padding: '0.75rem 1.5rem', background: '#fff', color: '#000', border: 'none', fontWeight: '800', fontSize: '0.75rem', borderRadius: '2px' }}>EXECUTE BIOSYNC SYNC</button>
                   </div>
            ...
            <div style={{ background: '#0a0a0a', border: '1px solid #222', borderRadius: '8px', overflow: 'hidden' }}>
               <div style={{ padding: '1rem 1.5rem', background: '#111', borderBottom: '1px solid #222', fontSize: '0.65rem', fontWeight: '800', letterSpacing: '0.15em', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Users size={14} color="#60a5fa" /> STUDENT-WISE ATTENDANCE ANALYTICS (MOCK)
               </div>
               <div style={{ padding: '2rem' }}>
                  <div style={{ border: '1px solid #222', borderRadius: '4px', overflow: 'hidden' }}>
                    <div style={{ padding: '1rem', background: '#141414', borderBottom: '1px solid #222', display: 'flex', justifyContent: 'space-between' }}>
      ...
      <section id="architectures" style={{ padding: '8rem 2rem', backgroundColor: '#080808' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ marginBottom: '5rem', textAlign: 'center' }}>
            <div style={{ color: '#60a5fa', fontSize: '0.85rem', fontWeight: '700', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: '1rem' }}>User Context Definition</div>
            <h2 style={{ fontSize: '3rem', fontWeight: '800', margin: '0 0 1rem 0' }}>Institutional Action Architectures.</h2>
            <p style={{ color: '#888', fontSize: '1.1rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      {/* 8. FINAL CTA & CONTACT */}
      <section style={{ padding: '8rem 2rem', background: '#111', borderTop: '1px solid #222' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '4rem' }}>
          
          {/* Left: Contact / Demo */}
          <div style={{ background: '#0a0a0a', padding: '3rem', borderRadius: '8px', border: '1px solid #222' }}>
            <h2 style={{ fontSize: '2.5rem', fontWeight: '800', marginBottom: '1rem', letterSpacing: '-0.02em', color: '#fff' }}>Book a Demo.</h2>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', color: '#ccc', fontSize: '0.9rem', fontWeight: '600' }}>
                <Mail size={18} color="#60a5fa" /> biosyncbot@gmail.com
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', color: '#ccc', fontSize: '0.9rem', fontWeight: '600' }}>
                <Phone size={18} color="#60a5fa" /> +91 6380231313
              </div>
            </div>
          </div>
          ...
          <div style={{ padding: '3rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div style={{ color: '#60a5fa', fontSize: '0.8rem', fontWeight: '700', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: '1rem' }}>Secure Endpoint</div>
            <h2 style={{ fontSize: '2.5rem', fontWeight: '800', marginBottom: '1.5rem', letterSpacing: '-0.02em', color: '#fff' }}>Deploy Complete Visibility.</h2>
            <p style={{ color: '#888', fontSize: '1.05rem', marginBottom: '3rem', lineHeight: '1.6' }}>
            ...
            <div>
              <button 
                onClick={() => navigate('/login')}
                style={{
                  backgroundColor: '#fff', color: '#000', border: 'none', padding: '1.25rem 2.5rem', borderRadius: '4px',
                  fontSize: '0.85rem', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '0.1em',
      ...
      {/* 9. FOOTER */}
      <footer style={{ padding: '5rem 2rem', background: '#030303', borderTop: '1px solid #111' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2rem', alignItems: 'center' }}>
          ...
          <div style={{ color: '#333', fontSize: '0.75rem', marginTop: '3rem' }}>
